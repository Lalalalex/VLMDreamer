...
@torch.no_grad()
@torch.inference_mode()
def ksampler(model, positive, positive_2, negative, latent, seed=None, steps=30, cfg=7.0, sampler_name='dpmpp_2m_sde_gpu',
    ...
    try:
        samples = ldm_patched.modules.sample.sample(model,
                                                    ...
                                                    positive, positive_2, negative, latent_image,
