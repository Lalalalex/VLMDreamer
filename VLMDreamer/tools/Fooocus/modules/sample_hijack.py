...
@torch.no_grad()
@torch.inference_mode()
def sample_hacked(model, noise, positive, positive_2, negative, cfg, device, sampler, sigmas, model_options={}, latent_image=None, denoise_mask=None, callback=None, disable_pbar=False, seed=None):
    ...
    if hasattr(model, 'extra_conds'):
        ...
        positive_2 = encode_model_conds(model.extra_conds, positive_2, noise, device, "positive_2", latent_image=latent_image, denoise_mask=denoise_mask)
    ...
    samples = sampler.sample(model_wrap, sigmas, extra_args, extra_args_2, callback_wrap, noise, latent_image, denoise_mask, disable_pbar)
